class CombinedProvider {
  constructor() {
    ...
    this.actions = {
      ...
      Query: () => require('actions/search/QueryActions'),
      QueryTree: () => require('actions/search/QueryTreeActions'),
    ...
    this.stores = {
      ...
      Query: () => require('stores/search/QueryStore'),
      QueryTree: () => require('stores/search/QueryTreeStore'),
